   ...
   checkValidity(value, rules) {
    ...
    render() {
        ...
        if(this.props.isAuthenticated){
            // ++EXP redirect = <Redirect to={this.props.authRedirect}/>
            console.log('++EXP Authenticated')
        ...
        return (
            ...
            {errorMsg}
                ...
                <Button btnType="Danger" clicked={this.switchInputHandler}>Switch to{this.state.signUp ? 'Login' : 'SignUp'}</Button>
            </div>
        )
    }
}
